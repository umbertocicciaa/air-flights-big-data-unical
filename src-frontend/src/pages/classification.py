...
st.markdown(""":blue[Questa pagina permette di addestrare un modello di classificazione con l'obiettivo di prevedere il ritardo di un volo.  Terminato l'addestramento è possibile visualizzare alcune metriche che indicano la bontà del modello addestrato.] """)
...
if(avvia_training):
    ...
    with st.spinner("Addestramento in corso... Questo potrebbe richiedere 5 minuti."):
        model = train_randomForest_model(df)
